                        ...
                        <ul class="slides"
                                ...
                                <div class="agile_tv_series_grid">
                                    <div class="col-md-6 agile_tv_series_grid_left">
                                        ...
                                        <div class="col-md-6 agile_tv_series_grid_right">
                                            ...
                                            <p class="fexi_header_para" style="max-he: 20ch"><span
                                                        class="conjuring_w3">Story Line<label>:</label></span> {{ $movie->tx_description_movie }}
                                                ...</p>
                                            <p class="fexi_header_para">
                                                <span>Date of Release<label>:</label></span> {{ $movie->qt_debut_movie }}
                                            </p>
                                            <p class="fexi_header_para">
                            ...
                            <li style="width: 1140px; float: left; display: block;" class="flex-active-slide">
                                <div class="agile_tv_series_grid">
                                    <div class="col-md-6 agile_tv_series_grid_left">
                                        <div class="w3ls_market_video_grid1">
                                            <img src="{{ asset('img/h1-1.jpg') }}" alt=" " class="img-responsive">
                                    ...
                                    <div class="col-md-6 agile_tv_series_grid_right">
                                        ...
                                        <p class="fexi_header_para"><span
                                                    class="conjuring_w3">Story Line<label>:</label></span> 720p,Bluray
                                            HD Free Movie Downloads, Watch Free Movies Online with high speed Free Movie
                                            Streaming | MyDownloadTube Lorraine and Ed Warren go to north London to help
                                            a single...</p>
                                    ...
                                    <div class="agileinfo_flexislider_grids">
                                        <div class="col-md-2 w3l-movie-gride-agile">
                                            <a href="single.html" class="hvr-shutter-out-horizontal"><img
                                                        src="{{ asset('img/m22.jpg') }}" title="album-name"
                                                        class="img-responsive" alt=" ">
                                                <div class="w3l-action-icon"><i class="fa fa-play-circle"
                                                                                aria-hidden="true"></i></div>
                                            </a>
